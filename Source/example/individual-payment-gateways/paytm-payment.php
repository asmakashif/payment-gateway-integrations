...
<?php
$currency = configItemData('payments.gateway_configuration.paytm.currency');
$currencySymbol = configItemData('payments.gateway_configuration.paytm.currencySymbol');
?>
