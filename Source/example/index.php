...
<body>
    ...
    <footer class="footer bg-light p-4 text-center">
        PayPage - 1.8.0 - <small class="text-muted"> PHP ready to use Payment Gateway Integrations</small> Design & Developed by <a href="https://livelyworks.net">LivelyWorks</a>
    </footer>
</body>
