                        ...
                        <div class="card-body">
                            ...
                            if (!$configData) {
                                ...
                                foreach ($configItem as $key => $value) {
                                    if ($value['enable'] and $key == 'mollie') { ?>
...
<?php
$currency = configItemData('payments.gateway_configuration.mollie.currency');
$currencySymbol = configItemData('payments.gateway_configuration.mollie.currencySymbol');
?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#lwPaymentForm').on('submit', function(e) {
            ...
            // mollie, Paytm, Instamojo or iyzico script for send ajax request to server side start
            if (paymentOption == 'mollie') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        //mollie response
                        if (response.paymentOption == "mollie") {
