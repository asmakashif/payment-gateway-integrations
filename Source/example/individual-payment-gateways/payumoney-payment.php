                        ...
                        <div class="card-body">
                            ...
                            if (!$configData) {
                                ...
                                foreach ($configItem as $key => $value) {
                                    if ($value['enable'] and $key == 'payumoney') { ?>
...
<?php
$currency = configItemData('payments.gateway_configuration.payumoney.currency');
$currencySymbol = configItemData('payments.gateway_configuration.payumoney.currencySymbol');
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#lwPaymentForm').on('submit', function(e) {
            ...
            // payumoney, Paytm, Instamojo or iyzico script for send ajax request to server side start
