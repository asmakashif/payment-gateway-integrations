                        ...
                        <div class="card-body">
                            ...
                            if (!$configData) {
                                ...
                                foreach ($configItem as $key => $value) {
                                    if ($value['enable'] and $key == 'bitpay') { ?>
...
<?php
$currency = configItemData('payments.gateway_configuration.bitpay.currency');
$currencySymbol = configItemData('payments.gateway_configuration.bitpay.currencySymbol');
?>
